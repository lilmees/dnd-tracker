...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public : {
      ...
      stripePk: process.env[process.env.NODE_ENV === 'production' ? 'STRIPE_LIVE_PK' : 'STRIPE_TEST_PK'],
    ...
    stripeSk: process.env[process.env.NODE_ENV === 'production' ? 'STRIPE_LIVE_SK' : 'STRIPE_TEST_SK']
  },
  vite: {
