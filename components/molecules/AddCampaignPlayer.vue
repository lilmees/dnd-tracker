...
<template>
  <Modal v-if="open" @close="$emit('close')">
    ...
    <FormKit id="form" v-model="form" type="form" :actions="false" message-class="error-message" @submit="addPlayer">
      ...
      <Button type="submit" :label="$t('players.add')" :loading="isLoading" inline bold />
    </FormKit>
  </Modal>
</template>
