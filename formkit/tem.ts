...
/**
  ...
  *
  * @checksum - 5735b71f318108963ef29ccfc781e62700fcb4004312b61869b39a944388e77a
  * @variables - radius=rounded-lg,spacing=2,scale=base
  * @theme - starter
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:dropdown__listitem': {
    ...
    'dark:data-[is-active]:before:ring-slate-300': true
  },
  ...
  range__input: {
    ...
    'dark:[&::-webkit-slider-thumb]:bg-slate-300': true,
    ...
    'dark:[&::-moz-range-thumb]:bg-slate-300': true
  },
  range__help: {
    'text-neutral-900': true,
    'text-xs': true,
  ...
  colorpicker__fieldGroup: {
    ...
    'max-[431px]:[&>input]:body-normal': true,
  ...
  dropdown__selector: {
    ...
    'group-data-[prefix-icon]:!pl-0': true,
    'group-data-[suffix-icon]:!pr-0': true,
    'data-[placeholder]:text-slate-300': true,
    'dark:text-neutral-100': true,
...
const globals: Record<string, Record<string, boolean>> = {
  ...
  inner: {
    ...
    'formkit-disabled:pointer-events-none': true,
    'transition-all': true,
    'duration-200': true
  },
  wrapper: {
